/// src/app/dashboard/manage-access/users/update/page.tsx
...
export default function UpdateUserPage() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    setSubmitting(true);
    try {
      await fetchFromAPI<{ message: string }>("/dashboardadmin/users/update", {
        method: "POST",
  ...
  return (
    <div className="w-[80%] flex flex-col gap-y-4 p-4">
      <h1 className="text-3xl font-bold flex flex-col justify-center">Update User</h1>
      <nav className="text-sm  underline-offset-1 underline flex items-center  gap-2">
        ...
        <span className="text-gray-700 font-medium">Update User</span>
      </nav>
