/* ------------------------------------------------------------------
   ...
   + affichage des attributs comme dans OrderPreview
------------------------------------------------------------------ */
"use client";
...
interface Order {
  ...
  pickupMagasin: Array<{ MagasinAddress: string }>;
...
export default function OrderDetailsPage() {
  ...
  const addressLabel = order.DeliveryAddress
    ...
    .join("\n");
  const magasinLabel =
    pickupList.map((m) => m.MagasinAddress).join("\n") || "—";
        ...
        <table className="w-full text-sm border border-gray-200">
          ...
          <tbody>
            {order.orderItems.map((it) => {
              ...
              // construis la ligne attributs comme dans OrderPreview
