/* ------------------------------------------------------------------
   ...
   Fenêtre modale de pré-visualisation de la commande
------------------------------------------------------------------ */
"use client";
...
const OrderPreview: React.FC<OrderPreviewProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="relative bg-white max-w-4xl w-[95%] max-h-[90%] overflow-auto rounded-lg py-6 px-4 flex flex-col gap-6 shadow-xl">
        {/* close */}
        <button
